          ...
          <div className="max-w-2xl mx-auto px-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500 transition-all bg-white"
              />
              {searchQuery && (
                <button
                  onClick={clearSearch}
