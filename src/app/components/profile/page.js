              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#fff" }}>
                    <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{ borderWidth: "2px", borderColor: "black" }}>
                      <span className="text-xs font-bold" style={{ color: "black" }}>%</span>
                    </div>
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#fff" }}>
                    <div className="relative">
                      <div className="w-6 h-2 rounded-full" style={{ backgroundColor: "black" }}></div>
                      <div className="w-6 h-2 rounded-full mt-1" style={{ backgroundColor: "black" }}></div>
                      <div className="w-6 h-2 rounded-full mt-1" style={{ backgroundColor: "black" }}></div>
                    </div>
                  </div>
                  <div>
